...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/mark-util-character
   cd mark-util-character
   ```
...
```sh
https://github.com/flex-development/mark-util-character/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/mark-util-character/discussions/new?category=q-a
